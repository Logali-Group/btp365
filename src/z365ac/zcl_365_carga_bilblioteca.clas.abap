class zcl_365_carga_bilblioteca definition
  public
  final
  create public .
...
CLASS ZCL_365_CARGA_BILBLIOTECA IMPLEMENTATION.


  method if_oo_adt_classrun~main.

    data: lt_acc_categ type table of ztb_365_acc_cat,
          lt_catego    type table of ztb_365_catego,
          lt_clientes  type table of ztb_365_clientes,
          lt_clnts_lib type table of ztb_365_cln_lib,
          lt_libros    type table of ztb_365_libros.
...
******** ztb_365_acc_cat ********
    ...
    delete from ztb_365_acc_cat.
    insert ztb_365_acc_cat from table @lt_acc_categ.
...
******** ztb_365_catego ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_365_catego.
    insert ztb_365_catego from table @lt_catego.
...
******** ztb_365_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_365_clientes.
    insert ztb_365_clientes from table @lt_clientes.
...
******** ztb_365_cln_lib
    ...
    "Delete possible entries; insert new entries
    delete from ztb_365_cln_lib.
    insert ztb_365_cln_lib from table @lt_clnts_lib.
...
******** ztb_365_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_365_libros.
    insert ztb_365_libros from table @lt_libros.
